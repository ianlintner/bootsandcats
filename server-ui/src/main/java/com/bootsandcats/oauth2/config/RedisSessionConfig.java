 ...
 *
 * <p>This configuration enables HTTP sessions to be stored in Redis, allowing multiple
 * application pods to share session state. This is essential for horizontal scaling
 * and high availability in Kubernetes environments.
 *
 * <p>The configuration is conditionally enabled based on the {@code spring.session.store-type}
 * property. Set it to "redis" to enable Redis sessions, or "none" to use default
 * in-memory sessions.
 *
 * <p>Key features:
 * <ul>
...
public class RedisSessionConfig {
     ...
     *
     * <p>This template can be used for additional Redis operations beyond session management,
     * such as caching OAuth2 authorization data.
     *
