...
echo ""
echo "Next steps:"
echo "1. Update k8s/secret-provider-class.yaml to include the new secrets"
echo "2. Update k8s/profile-ui-deployment.yaml to use the MongoDB environment variables"
echo "3. Apply the Kubernetes manifests:"
echo "   kubectl apply -f k8s/secret-provider-class.yaml"
echo "   kubectl apply -f k8s/profile-ui-deployment.yaml"
echo ""
