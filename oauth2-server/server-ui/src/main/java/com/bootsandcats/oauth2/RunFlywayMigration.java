...
/**
 * Standalone runner to execute Flyway migrations programmatically.
...
public class RunFlywayMigration {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nCurrent version: " + (flyway.info().current() != null ? flyway.info().current().getVersion() : "none"));
        System.out.println("\nExecuting migrations...");
        
        int migrationsApplied = flyway.migrate().migrationsExecuted;
        
        System.out.println("\nMigrations applied: " + migrationsApplied);
        System.out.println("Current version: " + (flyway.info().current() != null ? flyway.info().current().getVersion() : "none"));
