 ...
 *
 * <ul>
 *   <li>GitHub uses OAuth2 (not OIDC) - requires userInfoUri
 *   <li>Google uses OIDC - issuerUri enables discovery
 *   <li>Provider URIs must match WireMock server URLs
 * </ul>
 */
@TestConfiguration
public class TestFederatedIdentityConfiguration {
    ...
    public ClientRegistrationRepository federatedClientRegistrationRepository(Environment env) {
        return new InMemoryClientRegistrationRepository(
                githubClientRegistration(env), googleClientRegistration(env));
    }
