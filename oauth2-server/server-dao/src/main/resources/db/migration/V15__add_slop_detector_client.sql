-- Seed slop-detector confidential client for Envoy authorization-code token exchange
--
-- NOTE:
-- - The Istio EnvoyFilter `slop-detector-oauth2-exchange` exchanges the authorization code by POSTing
--   client_id/client_secret to /oauth2/token (client_secret_post).
-- - The redirect_uri used by that filter is: https://slop-detector.cat-herding.net/_oauth2/callback
--
-- SECURITY:
...
INSERT INTO oauth2_registered_client (
    ...
    'slop-detector-client-001',
    'slop-detector',
    CURRENT_TIMESTAMP,
    '{noop}REPLACE_WITH_SLOP_DETECTOR_CLIENT_SECRET',
    NULL,
    'Slop Detector Service',
    'client_secret_post',
    'authorization_code,refresh_token',
    'https://slop-detector.cat-herding.net/_oauth2/callback',
    'https://slop-detector.cat-herding.net/',
